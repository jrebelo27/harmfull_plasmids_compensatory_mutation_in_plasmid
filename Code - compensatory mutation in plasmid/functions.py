...
def bacterial_growth (focal_bacterium, list_spaces, filled_spaces):    
    ...
    if len(empty_positions) > 0:
        ...
        if final_type == 4 or final_type == 5 or final_type == 6:
            cost = 0
...
def conjugation(bacterium_to_conjugate, list_spaces, type_donor, cost_donor, time_donor):
    variables.recipient_bacteria -= 1
    type_recipient = list_spaces[bacterium_to_conjugate[0]][bacterium_to_conjugate[1]][2]
    if type_donor == 2:        
        if type_recipient == 4:
        ...
        if type_recipient == 4:
            list_spaces[bacterium_to_conjugate[0]][bacterium_to_conjugate[1]][2] = 3
            list_spaces[bacterium_to_conjugate[0]][bacterium_to_conjugate[1]][3] = cost_donor
            list_spaces[bacterium_to_conjugate[0]][bacterium_to_conjugate[1]][6] = time_donor
        elif type_recipient == 6:
            list_spaces[bacterium_to_conjugate[0]][bacterium_to_conjugate[1]][2] = 2
            list_spaces[bacterium_to_conjugate[0]][bacterium_to_conjugate[1]][3] = variables.permanent_plasmid_cost
            list_spaces[bacterium_to_conjugate[0]][bacterium_to_conjugate[1]][6] = 0
