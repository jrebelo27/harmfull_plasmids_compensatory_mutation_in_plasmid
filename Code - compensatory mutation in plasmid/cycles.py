    ...
    while number_times_full_grid <= 1073:        
        ...
        if c > 0:
            ...
            if focal_bacteria[2] == 2 or focal_bacteria[2] == 3:
                tipo_dadora = focal_bacteria[2]
                custo_dadora = focal_bacteria[3]
                tempo_dadora = focal_bacteria[6]
                ...
                if len(recipient_positions) > 0:
                    ...
                    if random.random() <= conjugation_probability:
                        ...
                        list_spaces = functions.conjugation([new_x, new_y], list_spaces, tipo_dadora, custo_dadora, tempo_dadora)  
